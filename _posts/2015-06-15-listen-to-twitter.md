...
Noisy Tweets is an application created in 24 hours that takes in a keyword as input. The application then live-streams all tweets containing that keyword, analyses how happy or sad (sentiment) the tweets are, and plays different musical notes depending on how happy or sad the tweets are.
